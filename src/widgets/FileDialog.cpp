...
void FileDialog::setShowHidden(bool show)
{
    ...
    dirCache_.setRoot(currentPath_);
    if (btnHidden_)
        btnHidden_->setIconId(show ? IconId::Eye : IconId::EyeOff);
    refreshDir();
}
